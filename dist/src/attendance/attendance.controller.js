...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AttendanceController.prototype, "confirmAttendance", null);
__decorate([
    (0, common_1.Patch)('confirm-all/:id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AttendanceController.prototype, "confirmAll", null);
__decorate([
    (0, common_1.Get)('user'),
